...
@section('body_right')
    ...
    <div class="col-lg-11" style="padding-bottom:120px">
        <form action="{!! route('admin.provin.postAdd') !!}" method="POST">
        <div class="pull-right">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="txtCompass">
                    ...
                    <option value="1" @if(old('txtCompass') == 1) selected  @endif>Miền Nam</option>
                    <option value="2" @if(old('txtCompass') == 2) selected  @endif>Miền Trung</option>
                    <option value="3" @if(old('txtCompass') == 3) selected  @endif>Miền Bắc</option>
                </select>
            ...
            <div class="form-group">
                <div class="radio">
                    <label>
                        <input type="radio" name="txtSearch" id="inputSearch" value="1" @if(old('search') == 1) checked="checked" @endif>
                        Search
                    </label>
                    <label>
                        <input type="radio" name="txtSearch" id="inputSearch" value="0"  @if(old('search') == 0) checked="checked" @endif>
                        Không Search
                    </label>
                </div>
