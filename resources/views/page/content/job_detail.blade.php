        ...
        <div class="row">
          ...
          <div class="col-sm-4" id="sidebar">
            ...
            <div class="sidebar-widget" id="company">
              ...
              <p><img src="images/client-logo.gif" alt="" class="img-responsive"></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            ...
            <form role="form" name="contact-form" id="contact-form" action="http://coffeecreamthemes.com/themes/jobseek/site/process.php">
