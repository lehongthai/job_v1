...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0; background: #000088">
                        <a href="index.html" class="site_title"><i class="fa fa-gears"></i> <span>NINEMOBI</span></a>
                    </div>
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="{{url('')}}/public/admin/images/img.jpg" class="img-circle profile_img">
                        </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <li>
                            ...
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! URL::route('admin.image.list') !!}">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.image.getAdd') !!}">Thêm Mới</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <li>
                                    <a href="{!! URL::route('admin.about.getListShop') !!}">Location</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-picture-o"></i>Tỉnh/Thành Phố<span class="fa arrow"></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! URL::route('admin.provin.list') !!}">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.provin.getAdd') !!}">Thêm Mới</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-picture-o"></i>Thông tin CV<span class="fa arrow"></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! url('admin/info/list/level') !!}">Bằng cấp</a>
                                </li>
                                <li>
                                   <a href="{!! url('admin/info/list/empirical') !!}">Kinh nghiệm </a>
                                </li>
                                <li>
                                    <a href="{!! url('admin/info/list/diploma') !!}">Cấp bậc hiện tại</a>
                                </li>
                                <li>
                                   <a href="{!! url('admin/info/list/diploma_wish') !!}">Cấp bậc mong muốn</a>
                                </li>
                                <li>
                                    <a href="{!! url('admin/info/list/exigency') !!}">Nhu cầu làm việc</a>
                                </li>
                                <li>
                                    <a href="{!! url('admin/info/list/type') !!}">Loại việc làm</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                         <li>
                            <a href="#"><i class="fa fa-picture-o"></i>Công Việc<span class="fa arrow"></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! URL::route('admin.job.list') !!}">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.job.getAdd') !!}">Thêm Mới</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-picture-o"></i>Quản lý câu hỏi<span class="fa arrow"></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! URL::route('admin.aq.list') !!}">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.aq.getAdd') !!}">Thêm Mới</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                         <li>
                            <a href="#"><i class="fa fa-picture-o"></i>Quản lý đăng việc<span class="fa arrow"></span></a>
                            <ul class="nav child_menu">
                                <li>
                                    <a href="{!! URL::route('admin.postjob.list') !!}">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('admin.postjob.getAdd') !!}">Thêm Mới</a>
                                </li>
                            </ul>
                            <!-- /.child_menu -->
                        </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    ...
                                    <li><a href="{{url('')}}/admin/change/pass"><i class="fa fa-sign-out pull-right"></i> Change Pass</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <!-- page content -->
            <div class="right_col" role="main" style="padding: 85px 20px; min-height: 2300px;">
                @yield('body_right')
            </div>
            <!-- /page content -->
        </div>
